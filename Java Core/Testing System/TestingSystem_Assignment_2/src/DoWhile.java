...
public class DoWhile {
	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("Thong tin department thu " + (j1 + 1) + " la:");
		...
		do {
			...
			System.out.println("Full Name: " + accounts[i1].fullName);
			System.out.println("Phong ban: " + accounts[i1].department.name);
			System.out.println("\n");
			i1++;
		...
		do {
			...
			System.out.println("Email: " + accounts[i2].email);
			System.out.println("Full Name: " + accounts[i2].fullName);
			System.out.println("Phong ban: " + accounts[i2].department.name);
			System.out.println("\n");
			i2++;
